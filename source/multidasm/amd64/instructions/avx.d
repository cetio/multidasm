    ...
    auto vaddpd(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128))
        => emit!(0, VEX, 128, 1, 0x66)(0x58, dst, src, stor);
    auto vaddpd(RM)(YMM dst, YMM src, RM stor) if (valid!(RM, 256))
        => emit!(0, VEX, 256, 1, 0x66)(0x58, dst, src, stor);
    ...
    auto vaddsd(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128, 64))
        => emit!(0, VEX, 128, 1, 0xf2)(0x58, dst, src, stor);
    /// www.felixcloutier.com/x86/addss
    auto vaddss(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128, 32))
        => emit!(0, VEX, 128, 1, 0xf3)(0x58, dst, src, stor);

    /// www.felixcloutier.com/x86/addsubpd
    auto vaddsubpd(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128))
        => emit!(0, VEX, 128, 1, 0x66)(0xd0, dst, src, stor);
    auto vaddsubpd(RM)(YMM dst, YMM src, RM stor) if (valid!(RM, 256))
        => emit!(0, VEX, 256, 1, 0x66)(0xd0, dst, src, stor);

    /// www.felixcloutier.com/x86/addsubps
    auto vaddsubps(RM)(XMM dst, XMM src, RM stor) if (valid!(RM, 128))
        => emit!(0, VEX, 128, 1, 0xf2)(0xd0, dst, src, stor);
    auto vaddsubps(RM)(YMM dst, YMM src, RM stor) if (valid!(RM, 256))
        => emit!(0, VEX, 256, 1, 0xf2)(0xd0, dst, src, stor);
